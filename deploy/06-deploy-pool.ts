...
const deployTestPoolContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const poolContractDeployTx = await reserveContract.deployPoolContract(testTokenAddress, "0x7a65726700000000000000000000000000000000000000000000000000000000", BigInt(2000000000000000000000))
    ...
    const poolInteraction1 = await poolContract.userWithdraw(BigInt(3500000000000000000000));
